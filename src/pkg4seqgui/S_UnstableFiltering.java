...
public class S_UnstableFiltering extends javax.swing.JPanel {
    ...
    private void S_BootstrapVideo_jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_S_BootstrapVideo_jButtonActionPerformed
        ...
        Integer ncluster, threshold; 

        if (MainFrame.checkPath(this, countsFile, "counts table file") ||
            MainFrame.checkPath(this, scratchFolder, "scratch folder"))
            return;

        if ((ncluster = MainFrame.checkIntValue(this, S_framePP.getText(), "number of clusters")) == null ||
            (threshold = MainFrame.checkIntValue(this, S_framePP1.getText(), "threshold")) == null)
            return;
        
        String outputFolder = Paths.get(countsFile).getParent().toString();
        ScriptCaller params = new ScriptCaller("unstableFiltering.R", outputFolder)
                ...
                .addArg("sThreshold", threshold);

        MainFrame.execCommand(this, "UnstableFiltering", params);
