 ...
 * @author user
 */
public class S_ScanpyBootstrap extends javax.swing.JPanel {

    /**
     * Creates new form S_SeuratBootstrap
     */
    public S_ScanpyBootstrap() {
        initComponents();
    }
    private static final long serialVersionUID = 67756333340L;
    /**
    ...
    private void initComponents() {
        ...
        S_SeuratBootstrapPanel = new javax.swing.JPanel();
        vCloseButton5 = new javax.swing.JButton();
        S_SeuratBootstrap_jButton = new javax.swing.JButton();
        ...
        S_SeuratBootstrapPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(30, 1, 1, 1), "Scanpy Bootstrap", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 14), new java.awt.Color(255, 102, 102))); // NOI18N
        S_SeuratBootstrapPanel.setToolTipText(null);
        S_SeuratBootstrapPanel.setLayout(new java.awt.GridBagLayout());
        ...
        S_SeuratBootstrapPanel.add(vCloseButton5, gridBagConstraints);

        S_SeuratBootstrap_jButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4seqgui/images/exec.png"))); // NOI18N
        S_SeuratBootstrap_jButton.setText("Execute");
        S_SeuratBootstrap_jButton.setToolTipText(null);
        S_SeuratBootstrap_jButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                S_SeuratBootstrap_jButtonActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        gridBagConstraints.weighty = 0.1;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        S_SeuratBootstrapPanel.add(S_SeuratBootstrap_jButton, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 0.1;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        S_SeuratBootstrapPanel.add(jButton40, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        S_SeuratBootstrapPanel.add(jPanel30, gridBagConstraints);
        ...
        S_format.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "txt", "csv" }));
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 7;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.FIRST_LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        S_SeuratBootstrapPanel.add(jPanel4, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.FIRST_LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        S_SeuratBootstrapPanel.add(jPanel31, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 0.1;
        gridBagConstraints.weighty = 0.1;
        add(S_SeuratBootstrapPanel, gridBagConstraints);
    ...
    private void S_SeuratBootstrap_jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_S_SeuratBootstrap_jButtonActionPerformed
        String countsFile = S_countTable.getText(), 
               scratchFolder = sScratchFolder.getText();
        Integer perplexity, pca_dim, nperm, seed, perm_group, perc; 

        if (MainFrame.checkPath(this, countsFile, "counts table file") ||
            MainFrame.checkPath(this, scratchFolder, "scratch folder"))
            return; 
        
        if ((perplexity = MainFrame.checkIntValue(this, S_Perplexity.getText(), "perplexity value for tsne projection")) == null ||
            ...
            (perm_group = MainFrame.checkIntValue(this, S_permAtTime.getText(), "number of permutations computed in parallel")) == null ||
            (perc = MainFrame.checkIntValue(this, S_percent.getText(), "percentage of randomly selected cells")) == null)
            return;             
        
        String outputFolder = Paths.get(countsFile).getParent().toString();
        ScriptCaller params = new ScriptCaller("ScanpyBootstrap.R", outputFolder)
                ...
                .addArg("format", S_format.getSelectedItem().toString());
        MainFrame.execCommand(this, "Scanpy Bootstrap", params);
    }//GEN-LAST:event_S_SeuratBootstrap_jButtonActionPerformed
    ...
    private javax.swing.JPanel S_SeuratBootstrapPanel;
    private javax.swing.JButton S_SeuratBootstrap_jButton;
