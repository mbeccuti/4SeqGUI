...
public class S_ClusterNgriph extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 53);
    ...
    private void S_ClusterNgriph_jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_S_ClusterNgriph_jButtonActionPerformed
        ...
        try{
            String[] cmd = {"/bin/bash","-c"," bash ./execClusterNgriph.sh "};
            ...
            if (MainFrame.listProcRunning.size()<MainFrame.GS.getMaxSizelistProcRunning()){
                ...
                MainFrame.ElProcRunning tmp= new MainFrame.ElProcRunning("Cluster N griph ", folder.toString(),pr,MainFrame.listModel.getSize());
                ...
                MainFrame.ElProcWaiting tmp= new MainFrame.ElProcWaiting("Cluster N griph ",folder.toString(),cmd,MainFrame.listModel.getSize());
        ...
        JOptionPane.showMessageDialog(this, "Cluster N griph task was scheduled","Confermation",JOptionPane.INFORMATION_MESSAGE);
