...
public class S_RecatPrediction extends javax.swing.JPanel {
    ...
    private void S_LorenzFilter_jButton39ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_S_LorenzFilter_jButton39ActionPerformed
        ...
        try{
            String[] cmd = {"/bin/bash","-c"," bash ./execRecatPrediction.sh "};
            ...
            if (MainFrame.listProcRunning.size()<MainFrame.GS.getMaxSizelistProcRunning()){
                ...
                MainFrame.ElProcRunning tmp= new MainFrame.ElProcRunning("Recat Prediction ", folder.toString(),pr,MainFrame.listModel.getSize());
                ...
                MainFrame.ElProcWaiting tmp= new MainFrame.ElProcWaiting("Recat Prediction ",folder.toString(),cmd,MainFrame.listModel.getSize());
        ...
        JOptionPane.showMessageDialog(this, "Recat Prediction task was scheduled","Confermation",JOptionPane.INFORMATION_MESSAGE);
