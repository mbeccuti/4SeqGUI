 ...
 */
public class Tools_BulkClusters extends javax.swing.JPanel {

        private static final long serialVersionUID = 77766633338L;
    /**
     * Creates new form SC_BulkClusters
     */
    public Tools_BulkClusters() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        bulkParams = new javax.swing.JPanel();
        ...
        BulkPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(30, 1, 1, 1), "Bulk Clusters", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 14), new java.awt.Color(187, 12, 225))); // NOI18N
        BulkPanel.setLayout(new java.awt.GridBagLayout());
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        BulkPanel.add(executionPanel, gridBagConstraints);

        bulkParams.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        bulkParams.setLayout(new java.awt.GridBagLayout());

        clLabel.setText("Clustering file: ");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.ABOVE_BASELINE_LEADING;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        bulkParams.add(clLabel, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        bulkParams.add(clTextField, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        bulkParams.add(browseCLButton, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE_TRAILING;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        bulkParams.add(resetCLButton, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.ABOVE_BASELINE_LEADING;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        bulkParams.add(clLabel1, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        bulkParams.add(inputFileTextField, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE_TRAILING;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        bulkParams.add(browseIFButton1, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE_TRAILING;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        bulkParams.add(resetIFButton, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.ABOVE_BASELINE_LEADING;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        bulkParams.add(clLabel2, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        bulkParams.add(scratchFolderTextField, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE_TRAILING;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        bulkParams.add(browseSFButton, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE_TRAILING;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        bulkParams.add(resetSFButton, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.ABOVE_BASELINE_LEADING;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        bulkParams.add(jLabel2, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        bulkParams.add(separatorComboBox, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        BulkPanel.add(bulkParams, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        BulkPanel.add(executeButton, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.FIRST_LINE_END;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        BulkPanel.add(resetButton, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.FIRST_LINE_END;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        BulkPanel.add(closeButton, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        add(BulkPanel, gridBagConstraints);
    ...
    private void executeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_executeButtonActionPerformed
        ...
        ScriptCaller params = new ScriptCaller("bulkClusters.R", outputFolder)
        ...
        MainFrame.execCommand(this, "Bulk Clusters", params);
    ...
    private javax.swing.JPanel bulkParams;
