 ...
 * @author user
 */
public class S_SeuratPCAEval extends javax.swing.JPanel {

    /**
     * Creates new form S_SeuratPCAEval
     */
    public S_SeuratPCAEval() {
        initComponents();
    }
    private static final long serialVersionUID = 67756333341L;
    /**
    ...
    private void initComponents() {
        ...
        S_SeuratPCAEvalPanel = new javax.swing.JPanel();
        vCloseButton5 = new javax.swing.JButton();
        S_SeuratPCAEval_jButton = new javax.swing.JButton();
        ...
        S_SeuratPCAEvalPanel.add(vCloseButton5, gridBagConstraints);

        S_SeuratPCAEval_jButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pkg4seqgui/images/exec.png"))); // NOI18N
        S_SeuratPCAEval_jButton.setText("Execute");
        S_SeuratPCAEval_jButton.setToolTipText(null);
        S_SeuratPCAEval_jButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                S_SeuratPCAEval_jButtonActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        gridBagConstraints.weighty = 0.1;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        S_SeuratPCAEvalPanel.add(S_SeuratPCAEval_jButton, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 0.1;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        S_SeuratPCAEvalPanel.add(jButton40, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        S_SeuratPCAEvalPanel.add(jPanel30, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.FIRST_LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        S_SeuratPCAEvalPanel.add(jPanel4, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.FIRST_LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        S_SeuratPCAEvalPanel.add(jPanel31, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 0.1;
        gridBagConstraints.weighty = 0.1;
        add(S_SeuratPCAEvalPanel, gridBagConstraints);
    ...
    private void S_SeuratPCAEval_jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_S_SeuratPCAEval_jButtonActionPerformed

        //execute code
        Runtime rt = Runtime.getRuntime();
        try{
            String[] cmd = {"/bin/bash","-c"," bash ./execSeuratPCAEval.sh "};
            ...
            if (MainFrame.listProcRunning.size()<MainFrame.GS.getMaxSizelistProcRunning()){
                ...
                MainFrame.ElProcRunning tmp= new MainFrame.ElProcRunning("Seurat PCA Eval ", folder.toString(),pr,MainFrame.listModel.getSize());
                ...
                MainFrame.ElProcWaiting tmp= new MainFrame.ElProcWaiting("Seurat PCA Eval ",folder.toString(),cmd,MainFrame.listModel.getSize());
        ...
        JOptionPane.showMessageDialog(this, "Seurat PCA Eval task was scheduled","Confermation",JOptionPane.INFORMATION_MESSAGE);

        //execute code
    }//GEN-LAST:event_S_SeuratPCAEval_jButtonActionPerformed
