...
public class S_TsneBootstrap extends javax.swing.JPanel {
    ...
    private void S_TsneBootstrap_jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_S_TsneBootstrap_jButtonActionPerformed
        ...
        Integer seed, nperm, perm_group, percent, range1, range2, perplexity;
        Float sp; 
        ...
        if ((seed = MainFrame.checkIntValue(this, S_seed.getText(), "seed")) == null ||
            ...
            (sp = MainFrame.checkFloatValue(this, S_Sp.getText(), "sp")) == null)
            return;

        String outputFolder = Paths.get(countsFile).getParent().toString();
        ScriptCaller params = new ScriptCaller("TsneBootstrap.R", outputFolder)
        ...
        MainFrame.execCommand(this, "Tsne Bootstrap", params);
