...
public class S_GenesPrioritization extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        S_GenesPrioritSIMLRPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(30, 1, 1, 1), "Genes prioritization with SIMLR", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 14), new java.awt.Color(255, 102, 102))); // NOI18N
        ...
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 57);
        ...
        jLabel122.setText("# of clusters to be inspected:");
    ...
    private void S_GenesPrioritSIMLR_jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_S_GenesPrioritSIMLR_jButtonActionPerformed
        ...
        Integer seed, nperm, permtime, percentage, ncluster;
        Float sp, cpe;
        ...
        if ((sp = MainFrame.checkFloatValue(this, S_sp.getText(), "sp")) == null || 
            (cpe = MainFrame.checkFloatValue(this, S_clusterPermErr.getText(), "cluster permutation error")) == null)
            return; 
        
        String outputFolder = Paths.get(countsFile).getParent().toString();
        ScriptCaller params = new ScriptCaller("genesPrioritization.R", outputFolder)
                ...
                .addArg("seed", seed)
                .addArg("sp", sp)
                .addArg("clusterPermErr", cpe); 
        MainFrame.execCommand(this, "Genes Prioritization", params);
