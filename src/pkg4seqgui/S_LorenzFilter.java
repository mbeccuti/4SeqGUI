 ...
 * @author user
 */
public class S_LorenzFilter extends javax.swing.JPanel {

    /**
     * Creates new form S_LorenzFilter
     */
    public S_LorenzFilter() {
        initComponents();
    }
    private static final long serialVersionUID = 67756333336L;
    /**
    ...
    private void initComponents() {
        ...
        S_pValue = new javax.swing.JTextField();
        ...
        S_LorenzFilterPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(30, 1, 1, 1), "Lorenz Filter", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 14), new java.awt.Color(255, 102, 102))); // NOI18N
        ...
        S_pValue.setText("0");
        S_pValue.setToolTipText(null);
        S_pValue.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                S_pValueFocusLost(evt);
            }
        });
        S_pValue.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                S_pValueActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        jPanel30.add(S_pValue, gridBagConstraints);
    ...
    private void S_LorenzFilter_jButton39ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_S_LorenzFilter_jButton39ActionPerformed
        ...
        try{
            String[] cmd = {"/bin/bash","-c"," bash ./execLorenzFilter.sh "};
 if (cSudoRadioButton.isSelected()){
            ...
            cmd[2]+=" p_value=\\\""+S_pValue.getText()+"\\\"";
            ...
            if (MainFrame.listProcRunning.size()<MainFrame.GS.getMaxSizelistProcRunning()){
                ...
                MainFrame.ElProcRunning tmp= new MainFrame.ElProcRunning("Lorenz Filter ", folder.toString(),pr,MainFrame.listModel.getSize());
                ...
                MainFrame.ElProcWaiting tmp= new MainFrame.ElProcWaiting("Lorenz Filter ",folder.toString(),cmd,MainFrame.listModel.getSize());
        ...
        JOptionPane.showMessageDialog(this, "Lorenz Filter task was scheduled","Confermation",JOptionPane.INFORMATION_MESSAGE);
    ...
    private void S_pValueFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_S_pValueFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_S_pValueFocusLost

    private void S_pValueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_S_pValueActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_S_pValueActionPerformed
    ...
    public static javax.swing.JTextField S_pValue;
