...
public class S_LorenzFilter extends javax.swing.JPanel {
    ...
    private void S_LorenzFilter_jButton39ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_S_LorenzFilter_jButton39ActionPerformed
        ...
        Float pvalue = MainFrame.checkFloatValue(this, S_pValue.getText(), "p-value"); 
        if (pvalue == null)
            return;
        
        String outputFolder = Paths.get(countsFile).getParent().toString();
        ScriptCaller params = new ScriptCaller("LorenzFilter.R", outputFolder)
                .addArg("group", cSudoRadioButton.isSelected() ? "sudo" : "docker")
                .addArg("scratch.folder", scratchFolder)
                .addArg("file", countsFile)
                .addArg("p_value", pvalue)
                .addArg("sep", S_separator.getSelectedItem().toString());
        MainFrame.execCommand(this, "Lorenz Filter", params);
