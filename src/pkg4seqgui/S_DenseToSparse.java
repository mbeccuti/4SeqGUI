 ...
 * @author user
 */
public class S_DenseToSparse extends javax.swing.JPanel {

    private static final long serialVersionUID = 67756333314L;
    /** Creates new form S_dim */
    public S_DenseToSparse() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        S_LorenzFilterPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(30, 1, 1, 1), "Dense To Sparse", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 14), new java.awt.Color(255, 102, 102))); // NOI18N
    ...
    private void S_LorenzFilter_jButton39ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_S_LorenzFilter_jButton39ActionPerformed
        ...
        try{
            String[] cmd = {"/bin/bash","-c"," bash ./execDenseToSparse.sh "};
            ...
            if (MainFrame.listProcRunning.size()<MainFrame.GS.getMaxSizelistProcRunning()){
                ...
                MainFrame.ElProcRunning tmp= new MainFrame.ElProcRunning("Dense To Sparse ", folder.toString(),pr,MainFrame.listModel.getSize());
                ...
                MainFrame.ElProcWaiting tmp= new MainFrame.ElProcWaiting("Dense To Sparse ",folder.toString(),cmd,MainFrame.listModel.getSize());
        ...
        JOptionPane.showMessageDialog(this, "Dense To Sparse task was scheduled","Confermation",JOptionPane.INFORMATION_MESSAGE);
