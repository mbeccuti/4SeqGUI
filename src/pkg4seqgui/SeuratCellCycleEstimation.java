 ...
 */
public class SeuratCellCycleEstimation extends javax.swing.JPanel {

    private static final long serialVersionUID = 77766633337L;
    /**
     * Creates new form SeuratCellCycleEstimation
     */
    public SeuratCellCycleEstimation() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        SeuratCCEPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(30, 1, 1, 1), "Seurat Cell Cycle Estimation", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 14), new java.awt.Color(8, 206, 99))); // NOI18N
        SeuratCCEPanel.setLayout(new java.awt.GridBagLayout());
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        SeuratCCEPanel.add(executionPanel, gridBagConstraints);

        seuratcceParams.setBorder(javax.swing.BorderFactory.createTitledBorder(""));
        seuratcceParams.setLayout(new java.awt.GridBagLayout());
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        seuratcceParams.add(clLabel1, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        seuratcceParams.add(inputFileTextField, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        seuratcceParams.add(browseIFButton1, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE_TRAILING;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        seuratcceParams.add(resetIFButton, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.ABOVE_BASELINE_LEADING;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        seuratcceParams.add(clLabel2, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        seuratcceParams.add(scratchFolderTextField, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE_TRAILING;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        seuratcceParams.add(browseSFButton, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE_TRAILING;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        seuratcceParams.add(resetSFButton, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.ABOVE_BASELINE_LEADING;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        seuratcceParams.add(jLabel2, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        seuratcceParams.add(separatorComboBox, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.ABOVE_BASELINE_LEADING;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        seuratcceParams.add(jLabel3, gridBagConstraints);

        randomSeedTextField.setText("111");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.gridwidth = 2;
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.BASELINE;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        seuratcceParams.add(randomSeedTextField, gridBagConstraints);
        ...
        gridBagConstraints.fill = java.awt.GridBagConstraints.HORIZONTAL;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        SeuratCCEPanel.add(seuratcceParams, gridBagConstraints);
        ...
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        SeuratCCEPanel.add(executeButton, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.FIRST_LINE_END;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        SeuratCCEPanel.add(resetButton, gridBagConstraints);
        ...
        gridBagConstraints.anchor = java.awt.GridBagConstraints.FIRST_LINE_END;
        gridBagConstraints.insets = new java.awt.Insets(10, 10, 10, 10);
        SeuratCCEPanel.add(closeButton, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        add(SeuratCCEPanel, gridBagConstraints);
    ...
    private void executeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_executeButtonActionPerformed
        ...
        if ((seed = MainFrame.checkIntValue(this, randomSeedTextField.getText(), "random seed")) == null)
            return; 

        String outputFolder = Paths.get(inputFile).getParent().toString();
        ScriptCaller params = new ScriptCaller("seuratCCycle.R", outputFolder)
            ...
            .addArg("seed", seed);
        MainFrame.execCommand(this, "Seurat Cell Cycle Estimation", params);
    ...
    private javax.swing.JPanel SeuratCCEPanel;
    ...
    private javax.swing.JPanel seuratcceParams;
