 ...
 * @author user
 */
public class S_BootstrapsVideo extends javax.swing.JPanel {

    /**
     * Creates new form S_BootstrapsVideo
     */
    public S_BootstrapsVideo() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        S_permutationNumber = new javax.swing.JTextField();
        ...
        S_BootstrapVideoPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(30, 1, 1, 1), "Bootstraps Video", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 1, 14), new java.awt.Color(255, 102, 102))); // NOI18N
        ...
        jLabel120.setText("# of clusters to be inspected:");
        ...
        S_permutationNumber.setText("80");
        S_permutationNumber.setToolTipText(null);
        S_permutationNumber.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                S_permutationNumberFocusLost(evt);
            }
        });
        S_permutationNumber.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                S_permutationNumberActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        gridBagConstraints.weightx = 0.5;
        gridBagConstraints.insets = new java.awt.Insets(10, 27, 10, 10);
        jPanel4.add(S_permutationNumber, gridBagConstraints);
    ...
    private void S_BootstrapVideo_jButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_S_BootstrapVideo_jButtonActionPerformed
        ...
        int nperm = 0, ncluster = 0, framepp = 0; 
        ...
        try {
            nperm = Integer.valueOf(S_permutationNumber.getText().trim());
            if (nperm < 0) {
                JOptionPane.showMessageDialog(this, 
                        "You have to specify a value greater than 0.",
                        "Error: Number of permutations",
                        JOptionPane.ERROR_MESSAGE);
                S_permutationNumber.requestFocusInWindow();
                return;
            }
        ...
        try {
            ncluster = Integer.valueOf(S_nCluster.getText().trim());
            if (ncluster < 0) {
                JOptionPane.showMessageDialog(this, 
                        "You have to specify a value greater than 0.",
                        "Error: Number of clusters to be inspected",
                        JOptionPane.ERROR_MESSAGE);
                S_nCluster.requestFocusInWindow();
                return;
            }
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, 
                    "You have to specify the number of clusters that will be used.",
                    "Error: Number of clusters to be inspected",
                    JOptionPane.ERROR_MESSAGE);
            S_nCluster.requestFocusInWindow();
            return;
        ...
        try {
            framepp = Integer.valueOf(S_framePP.getText().trim());
            if (framepp < 0) {
                JOptionPane.showMessageDialog(this, 
                        "You have to specify a value greater than 0.",
                        "Error: FramePP value",
                        JOptionPane.ERROR_MESSAGE);
                S_framePP.requestFocusInWindow();
                return;
            }
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, 
                    "You have to specify the framePP value that will be used.",
                    "Error: FramePP value",
                    JOptionPane.ERROR_MESSAGE);
            S_framePP.requestFocusInWindow();
            return;
        ...
        ScriptCaller params = new ScriptCaller("BootstrapsVideo.R", outputFolder)
                ...
                .addArg("framePP", framepp)
                .addArg("permutationNumber", nperm);                 
        
        MainFrame.execCommand(this, "Bootstrap video", params);
    ...
    private void S_permutationNumberFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_S_permutationNumberFocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_S_permutationNumberFocusLost

    private void S_permutationNumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_S_permutationNumberActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_S_permutationNumberActionPerformed
    ...
    public static javax.swing.JTextField S_permutationNumber;
