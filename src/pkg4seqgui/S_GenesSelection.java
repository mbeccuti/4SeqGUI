...
public class S_GenesSelection extends javax.swing.JPanel {
    ...
    private void S_GenesSelectionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_S_GenesSelectionButtonActionPerformed
        ...
        Integer seed, ncluster;
        Float sp, cpe, max_delta, min_mean;
        ...
        if ((sp = MainFrame.checkFloatValue(this, S_sp.getText(), "sp")) == null || 
            ...
            (max_delta = MainFrame.checkFloatValue(this, S_maxDeltaConfidence.getText(), "max delta confidence")) == null ||
            (min_mean = MainFrame.checkFloatValue(this, S_minLogMean.getText(), "min log mean")) == null)
            return; 
        
        String outputFolder = Paths.get(countsFile).getParent().toString(); 
        ScriptCaller params = new ScriptCaller("GenesSelection.R", outputFolder)
                ...
                .addArg("maxDeltaConfidence", max_delta)
                .addArg("minLogMean", min_mean);
        MainFrame.execCommand(this, "Genes Selection SIMLR", params);
